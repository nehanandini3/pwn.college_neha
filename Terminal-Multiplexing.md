...
- The challenge requires to reatach using `tmux a`
- Use the shortcut keys `Ctrl-B 0` to change the window and retrieve the flag

## Flag:

```
pwn.college{wkSDabK2zILSQ1gbkVIwTjvoWQZ.0FM5IDOxwCO0AzNzEzW}
```
